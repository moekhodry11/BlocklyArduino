...
Blockly.Msg.ARD_LCD_BEGIN = "begin";
Blockly.Msg.ARD_LCD_BEGIN_TIP = "Initializes the LCD display";
Blockly.Msg.ARD_LCD_PRINT = "print";
Blockly.Msg.ARD_LCD_PRINT_TIP = "Prints text on the LCD display";
Blockly.Msg.ARD_LCD_PRINT_POSITION = "print at position";
Blockly.Msg.ARD_LCD_PRINT_POSITION_TIP =
  "Prints text on the LCD display at the specified position";
Blockly.Msg.ARD_LCD_CLEAR = "clear";
Blockly.Msg.ARD_LCD_CLEAR_TIP = "Clears the LCD display";
Blockly.Msg.ARD_LCD_SET_CURSOR = "set cursor";
Blockly.Msg.ARD_LCD_SET_CURSOR_TIP =
  "Sets the cursor to the specified position";
Blockly.Msg.ARD_LCD_SET_CURSOR_POSITION = "position";
Blockly.Msg.ARD_LCD_SET_CURSOR_POSITION_TIP =
  "Sets the cursor to the specified position";
...
Blockly.Msg.ARD_SD_BEGIN_TIP = "Initializes the SD card";
Blockly.Msg.ARD_SD_OPEN = "open";
Blockly.Msg.ARD_SD_OPEN_TIP = "Opens a file on the SD card";
Blockly.Msg.ARD_SD_WRITE = "write";
Blockly.Msg.ARD_SD_WRITE_TIP = "Writes data to a file on the SD card";
Blockly.Msg.ARD_SD_READ = "read";
Blockly.Msg.ARD_SD_READ_TIP = "Reads data from a file on the SD card";
Blockly.Msg.ARD_SD_AVAILABLE = "available";
Blockly.Msg.ARD_SD_AVAILABLE_TIP = "Checks if the SD card is available";
Blockly.Msg.ARD_SD_EXISTS = "exists";
Blockly.Msg.ARD_SD_EXISTS_TIP = "Checks if a file exists on the SD card";
Blockly.Msg.ARD_SD_REMOVE = "remove";
Blockly.Msg.ARD_SD_REMOVE_TIP = "Removes a file from the SD card";
Blockly.Msg.ARD_SD_RENAME = "rename";
Blockly.Msg.ARD_SD_RENAME_TIP = "Renames a file on the SD card";
Blockly.Msg.ARD_SD_MKDIR = "make directory";
Blockly.Msg.ARD_SD_MKDIR_TIP = "Creates a directory on the SD card";

//add tips for ultrasonic
Blockly.Msg.ARD_ULTRASONIC_SETUP = "setup";
Blockly.Msg.ARD_ULTRASONIC_SETUP_TIP = "Initializes the ultrasonic sensor";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE = "distance";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_TIP =
  "Returns the distance measured by the ultrasonic sensor";

//add tips fort tmp36
Blockly.Msg.ARD_TMP36_SETUP = "setup";
Blockly.Msg.ARD_TMP36_SETUP_TIP = "Initializes the TMP36 sensor";
Blockly.Msg.ARD_TMP36_TEMPERATURE = "temperature";
Blockly.Msg.ARD_TMP36_TEMPERATURE_TIP =
  "Returns the temperature measured by the TMP36 sensor";

//add tips for ldr
Blockly.Msg.ARD_LDR_SETUP = "setup";
Blockly.Msg.ARD_LDR_SETUP_TIP = "Initializes the LDR sensor";
Blockly.Msg.ARD_LDR_READ = "read";
...
//add tips for servo
Blockly.Msg.ARD_SERVO_ATTACH = "attach servo";
Blockly.Msg.ARD_SERVO_ATTACH_TIP = "Attaches a servo to a pin";
Blockly.Msg.ARD_SERVO_DETACH = "detach servo";
Blockly.Msg.ARD_SERVO_DETACH_TIP = "Detaches a servo from a pin";
